...
#elif defined (CONFIG_T10) || defined (CONFIG_T20) || defined (CONFIG_T30)
...
#ifdef CONFIG_SET_ETHADDR

	eth_getenv_enetaddr("ethaddr", eth_get_dev()->enetaddr);

	// Set MAC address
	synopGMAC_set_mac_addr(gmacdev,GmacAddr0High,GmacAddr0Low, eth_get_dev()->enetaddr);
