...
extern void sfc_nor_read(unsigned int src_addr, unsigned int count,unsigned int dst_addr);
extern void sfc_nor_write(unsigned int src_addr, unsigned int count,unsigned int dst_addr);
extern void sfc_nor_erase(unsigned int src_addr, unsigned int count);
