...
extern void sfc_nor_read(unsigned int offset, unsigned int size, char *buf);
extern void sfc_nor_write(unsigned int offset, unsigned int size, char *buf);
extern void sfc_nor_erase(unsigned int offset, unsigned int size);
